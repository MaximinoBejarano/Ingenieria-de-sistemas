...
public class WorkIndicatorDialog<P> {
    ...
    private final Scene scene = new Scene(root, 230, 140, Color.web("#AEB6BF"));
    ...
    public WorkIndicatorDialog(Window owner, String label) {
        ...
        this.label.setFont(Font.font("System", FontWeight.BOLD, 18));
        this.label.setTextFill(Color.WHITE);               
        this.progressIndicator.setStyle("-fx-accent: white;");        
    }
